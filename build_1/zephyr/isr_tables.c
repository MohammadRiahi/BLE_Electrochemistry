...
struct _isr_table_entry __sw_isr_table _sw_isr_table[48] = {
	{(const void *)0x2739f, (ISR)0x274cd}, /* 0 */
	...
	{(const void *)0x1d1dd, (ISR)0x274cd}, /* 6 */
	{(const void *)0x28e88, (ISR)0x1a591}, /* 7 */
